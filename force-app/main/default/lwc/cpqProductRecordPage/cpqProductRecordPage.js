...
export default class CpqProductRecordPage extends LightningElement {
    ...
    wiredProduct({ data }) {
        if (data) Object.assign(this, { product: data });
    }
    ...
    calculateKPIs() {
        ...
        // Month name mapping for peak usage calculation
        const usageByMonth = {};
        ...
        this.allQuotes.forEach(q => {
            ...
            // Map periods for Peak Usage (Simple monthly count)
    ...
    drawGantt() {
        ...
        const totalRev = this.allQuotes.reduce((s, q) => s + q.revenue, 0); // Use global total for % calculation as in mock
