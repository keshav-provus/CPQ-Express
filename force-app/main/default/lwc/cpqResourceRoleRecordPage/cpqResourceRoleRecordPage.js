...
import getResourceRoleById from '@salesforce/apex/ProductController.getResourceRoleById';
import getResourceRoleUsage from '@salesforce/apex/ProductController.getResourceRoleUsage';
import getDefaultCurrency from '@salesforce/apex/AdminSettingsController.getDefaultCurrency';

export default class CpqResourceRoleRecordPage extends LightningElement {
    ...
    @wire(getResourceRoleById, { roleId: '$recordId' })
    wiredItem({ data }) {
